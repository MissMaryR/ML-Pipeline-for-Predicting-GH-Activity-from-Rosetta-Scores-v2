#!/usr/bin/env python3
"""
1b_train_extratrees.py
----------------------
- Reads Book1_aggregated_with_split.csv (created by 1a_train_logreg.py)
- Ranks features using ExtraTrees native feature importances
...
MODEL_OUT       = 'model_extratrees.joblib'
FEATURES_OUT    = 'features_extratrees.txt'
THRESHOLD_OUT   = 'threshold_extratrees.txt'
METRICS_OUT     = 'metrics_extratrees.json'
EXCEL_OUT       = 'metrics_extratrees.xlsx'
PLOT_OUT        = 'feature_importance_extratrees.png'
...
# ============================================================
# FEATURE RANKING via ExtraTrees importances
# ============================================================
print("\n🔎 Ranking features with ExtraTrees feature importances...")

smote = SMOTE(random_state=RANDOM_STATE)
X_train_res, y_train_res = smote.fit_resample(X_train, y_train)

ranking_clf = ExtraTreesClassifier(
    n_estimators=2000,
...
while True:
    try:
        chosen_n = int(input(f"\n🔢 How many features for the final ExtraTrees model? (1–{len(ordered_features)}): "))
...
# TRAIN FINAL MODEL
# ============================================================
print(f"\n🏋️  Training final ExtraTrees model with {chosen_n} features...")
...
plt.title(f'ExtraTrees Feature Importances (n={chosen_n})')
plt.tight_layout()
plt.savefig(PLOT_OUT, dpi=300)
plt.close()
print(f"  ✅ Feature importance plot saved: {PLOT_OUT}")

print(f"\n🎉 Done! Run 1c and 1d next.")
